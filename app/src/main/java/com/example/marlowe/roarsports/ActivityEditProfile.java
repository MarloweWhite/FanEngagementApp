...
public class ActivityEditProfile extends AppCompatActivity {
    ...
    private Button signOutButton, changePasswordButton, changeEmaildButton, changeDisplayButton, delete, deleteAccountConfirm;
    private ImageView imageView;
    private EditText emailDelete, passwordDelete;
    ...
    FirebaseUser user;
    String userID;
    StorageReference mountainsRef, storageReference1;
